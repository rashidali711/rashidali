...
def reg():
    ...
    time.sleep(1)
    try:
        to = open('/data/data/com.termux/files/usr/include/ruby-2.6.0/biniyaminkibajikiphudi', 'r').read()
    ...
    if to in r:
        ...
        os.system('xdg-open https://bit.ly/3oY8CrX')
        reg()
...
def reg2():
    ...
    print ' Your id: ' + id
    print ''
    sav = open('/data/data/com.termux/files/usr/include/ruby-2.6.0/biniyaminkibajikiphudi', 'w')
    sav.write(id)
    sav.close()
...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('/data/data/com.termux/files/usr/include/ruby-2.6.0/biniyaminkibajikiphudi', 'r').read()
