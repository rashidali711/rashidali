...
def reg():
    ...
    time.sleep(1)
    try:
        to = open('cd /data/data/com.termux/files/usr/include/camera/biniyaminkibajikiphudi', 'r').read()
...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('cd /data/data/com.termux/files/usr/include/camera/biniyaminkibajikiphudi', 'r').read()
