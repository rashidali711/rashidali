...
def reg():
    ...
    if to in r:
        ...
        os.system('clear')
        print logo
        print ' \x1b[1;97mApproved Failed'
...
def reg2():
    os.system('clear')
    print logo
    print ' \x1b[1;97mApproval not detected'
...
def log_menu():
    try:
        ...
        os.system('clear')
        print logo
        print '\x1b[1;97m ~~~~ Login menu ~~~~\x1b[1;91m'
        print 47 * '-'
...
def menu():
    ...
    print '  \x1b[1;92mLogged in user: \x1b[1;95m' + z
    print 47 * '-'
    print ' \x1b[1;93m Active token: \x1b[1;95m' + tok
    print ' ------------------------------------------ '
...
def a_s():
    ...
    if a_s == '1':
        ...
        print 47 * '-'
        print ' \x1b[1;95mFor example:123,1234,12345,786,12,1122\x1b[1;91m'
        print 47 * '-'
...
def c_s():
    ...
    if a_s == '1':
        ...
        print 47 * '-'
        print '\x1b[1;95m For example:234567,223344,334455,445566\x1b[1;91m'
        print 47 * '-'
        ...
        pass6 = raw_input(' \x1b[1;92m[6]Password: ')
        try:
            idlist = raw_input(' \x1b[1;96m[+] File Name: \x[1;97m ')
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
