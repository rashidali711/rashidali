...
def log_menu():
    try:
        ...
        print ''
        print 47 * '-'
        print '\x1b[1;95mSelect 2 And Login With Token'
        print ''
        print '\x1b[1;95mBiniyamin Bhai Try'
        print ''
        log_menu_s()
...
def menu():
    ...
    print ' ------------------------------------------ '
    print '\x1b[1;92m[1] Make File'
    print '\x1b[1;92m[2] Crack with Auto password 10'
    print '\x1b[1;92m[3] Crack with Number password 6'
    print '\x1b[1;92m[4] Crack with Name + Number password 8'
